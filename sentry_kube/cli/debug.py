...
def debug(ctx, container, image, namespace, quiet):
    ...
    # Filter out duplicated volume mounts, these may have been generated by rewriting the subpath mounts.
    volume_mounts = [vm for vm in volume_mounts if not any(vm2["mountPath"] == vm["mountPath"] for vm2 in volume_mounts)]
